...
const PORCU = {
  ...
  backStory:
    'Porcu used to live a peaceful life. He lived in the Coral Reefs of the Vast Sea, right next to city of Delareum. But that wicked night changed everything. City of Delareum was not too organized and it was lead by scoundrels and thugs. They had planned for some while now to steal the riches of Coral Reef, and during the night they came. Porcu barely managed to get away, but he wasn\'t able to save his fiancé. Next day he went back to the Reefs to recover his suit from his hideout. When he saw the destruction he vowed to have his revenge on his loved one and replenish world from evil.',
  ...
  life_powers: { healthpoints: 800, mana: 0 },
  skills: [
    {
      name: 'Plasma beam',
      damage: 200,
...
const LISA = {
  ...
  life_powers: { healthpoints: 500, mana: 0 },
  skills: [
    {
      name: 'Dynamite',
      damage: 70,
...
const GIDEON = {
  ...
  life_powers: { healthpoints: 300, mana: 20000 },
  skills: [
    {
      name: 'Telekinesis',
      damage: 0,
